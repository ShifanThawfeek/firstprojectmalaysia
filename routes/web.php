...
Route::group(['middleware' => ['auth', 'checkSubscription']], function () {
    ...
    Route::post('/student-register', [StudentController::class, 'insert'])->name('student-register');
    Route::get('list', [StudentController::class, 'list']);
    Route::view('/about', 'auth.StudentForm')->name('about');// this shows the students registration form
    // shifan add end
