        ...
        <v-layout row wrap justify-center>
            <v-flex xs10 sm10 md10 lg4 xl4>
                ...
                <div v-if="social" :style="`display: flex; justify-content: center; margin-top: 40px; margin-bottom: 15px;`">
                    ...
                    <v-icon @click="goToSm('paypal')" :style="`color: ${user.customization.iconColor}!important`" class="mx-2 text-h4" v-if="social.paypal">
                        mdi-paypal
                    </v-icon>
                    <v-icon @click="goToSm('tiktok')" :style="`color: ${user.customization.iconColor}!important`" class="mx-2 text-h4" v-if="social.tiktok">
                        mdi-tiktok
                    </v-icon>
                    <v-icon @click="goToSm('line')" :style="`color: ${user.customization.iconColor}!important`" class="mx-2 text-h4" v-if="social.line">
                        mdi-line
                    </v-icon>
                </div>
                <div style="display: flex; justify-content: center">
