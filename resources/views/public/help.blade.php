    ...
    <div class="col-md-2 col-lg-2 col-sm-2 col-xs-2" style="display: flex; justify-content: center; margin-top: 50px; margin-bottom: 50px">
      <table class="table">
        <tbody>
          <tr>
            <td style="text-align: center;">
              <img style="width: 80px;  " src="{{ url('assets/images/icons/mail.svg') }}" class="img-fluid feature-image" alt="Solution">
    ...
    <div class="col-md-2 col-lg-2 col-sm-2 col-xs-2" style="display: flex; justify-content: center; margin-top: 50px; margin-bottom: 50px">
      <table class="table">
        <tbody>
          <tr>
            <td style="text-align: center;">
              <img style="width: 80px;  " src="{{ url('assets/images/icons/faqs.svg') }}" class="img-fluid feature-image" alt="Solution">
        ...
        <form class="form-inline my-2 my-lg-0">
          <div>
            <button class="btn btn-outline-success my-2 my-sm-0 btn-lg text-white" type="submit" style="background: #17d8e2; border-radius: 18px; width: 190px; height: 110px">
              <p style="color: black;">Getting Started with MataOnMe</p>
            </button>
            &nbsp;&nbsp;&nbsp;
            <button class="btn btn-outline-success my-2 my-sm-0 btn-lg text-white" type="submit" style="background: #17d8e2; border-radius: 18px; width: 190px; height: 110px">
